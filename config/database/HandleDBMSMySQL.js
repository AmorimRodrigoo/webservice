    ...
    constructor(host = null, database = null, user = null, password = null) {
        ...
        if (envFile) {
            this._host = (typeof host !== 'string' || host === null) ?
                envFile.host : host;
            this._database = (typeof database !== 'string' || database === null) ?
                envFile.database : database;
            this._user = (typeof user !== 'string' || user === null) ?
                envFile.user : user;
...
var instancia = new HandleDBMSMySQL();


var retorno =  instancia.query('')